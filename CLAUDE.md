...
6. **Keine erfundenen Zahlen.** Fachaussagen aus `50_Quellen/Literatur.md`, Messwerte aus Versuchen.
   ...
   - **Erhebungen am Team** — Team-Management-Barometer, Retrospektiv-Bewertungen, Zufriedenheitswerte — werden **nie** vorausgefüllt, auch nicht auf ausdrückliche Bitte. Sie sind Messungen an Personen; erfundene Werte im Statusbericht wären eine Falschaussage gegenüber dem Auftraggeber. Claude bereitet den Erhebungsbogen vor und sagt, wie lange das Ausfüllen dauert.
