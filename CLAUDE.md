...
6. **Keine erfundenen Zahlen.** Fachaussagen aus `50_Quellen/Literatur.md`, Messwerte aus Versuchen.
   ...
   - **Erhebungen am Team** — Team-Management-Barometer, Retrospektiv-Bewertungen, Zufriedenheitswerte — sind Messungen an Personen. **Die Werte setzt das Team, nicht Claude.** Claude darf vom Team genannte oder bereits im Repository stehende Werte übernehmen, korrigieren, auswerten und grafisch aufbereiten. Werte, die niemand genannt hat, erfindet Claude nicht — fehlt eine Erhebung, bereitet Claude den Erhebungsbogen vor und sagt, wie lange das Ausfüllen dauert.
