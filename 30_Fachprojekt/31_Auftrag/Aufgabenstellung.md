---
typ: auftrag
titel: "Aufgabenstellung Bachelorprojekt"
bereich: bp
tags:
  - bp
  - auftrag
...
# Aufgabenstellung Bachelorprojekt

> **Quelle:** [[Aufgabenstellung.pdf]] (1 Seite, erstellt 22.03.2026, Autor „Ibg", Microsoft Word).
> Diese Markdown-Datei enthält den vollständigen Informationsgehalt der Original-PDF.
...
| Betreuer | Prof. Dr.-Ing. Dietmar Pähler |
| E-Mail | dietmar.paehler@haw-hamburg.de |
| Telefon | (040) 42875 8795 |
| Bevorzugter Kontakt | Per E-Mail oder Chat-Funktion in MS Teams |
| Anzahl Plätze | 4, davon noch frei: 4 (Stand 20.12.2025) |
...
**Abbildung (Foto):** Zwei Hände arbeiten an einem geöffneten, zweiteiligen Formkasten aus Metall. Der Kasten ist mit rötlich-orangem Formsand gefüllt; sichtbar ist das Einformen bzw. Nachverdichten des Sandes um ein Modell (Handformverfahren). Die Abbildung illustriert das im Projekt geplante manuelle Sandgussverfahren.
...
- In geeignet gestalteten praktischen **Vorversuchen** bestimmen Sie die benötigten Versuchsmaterialien: Form-/Kernsand, Binder, Trennmittel, Werkstückmaterial (möglichst **niedrigschmelzend**, damit eine einfache **Kochplatte** zum Erschmelzen/Recycling genutzt werden kann).
...
## Abgeleitete Kernanforderungen (Interpretation, nicht Teil der Original-PDF)

| Nr. | Anforderung | Typ |
|---|---|---|
| A1 | Laborversuch für FtT-Labor, 3. Semester, Dauer 2 Laborviertel | Festforderung |
| A2 | Reales Metallbauteil wird im Versuch sicher hergestellt | Festforderung |
| A3 | Bauteil erfordert mindestens einen Kern | Festforderung |
| A4 | Modell, Ober-/Unterkasten und Kernkasten werden selbst konstruiert und gefertigt | Festforderung |
| A5 | Werkstückwerkstoff niedrigschmelzend, erschmelzbar auf einfacher Kochplatte | Festforderung |
| A6 | Werkstoff recyclingfähig (Wiedereinschmelzen der Gussteile) | Festforderung |
| A7 | Materialauswahl (Sand, Binder, Trennmittel, Werkstoff) über dokumentierte Vorversuche | Festforderung |
| A8 | Versuchsskript für Studierendengruppen; hoher Eigenanteil der Studierenden unter Anleitung | Festforderung |
| A9 | Test im realen Laborbetrieb S26 | Wunsch („falls möglich") |
| A10 | Abschluss idealerweise vor Klausurphase S26 | Wunsch |
