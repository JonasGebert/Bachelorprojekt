...
Bei den niedrigen Gießtemperaturen des Projekts (< 300 °C, → [[Werkstoffe]]) sind die thermischen Anforderungen an den Sand unkritisch; entscheidend sind **Formbarkeit, Festigkeit und Gasdurchlässigkeit**.
...
| Ölanteil | zu viel → Rauch beim Abguss (Rauchpunkt Speiseöl ~200 °C < T_Gieß) + Gasporen; zu wenig → bröckelige Form | Rezepturreihe in V-F1 (z. B. 3/5/8 Ma.-%), Rauchentwicklung bewerten (→ [[Arbeitssicherheit]] G9) |
...
- [ ] Ergebnis-Rezeptur in [[Entscheidungsregister]] E4 nachtragen (Ma.-%, Marke, Siebweite)

**Warnhinweis (bleibt gültig):** Auch bei ölgebundenem Sand gilt — **kein Wasser am Gießplatz**, kein feuchtes Einsatzmaterial in die Schmelze (→ [[Arbeitssicherheit]] G2).
