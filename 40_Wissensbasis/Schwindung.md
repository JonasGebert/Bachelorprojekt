...
**Besonderheit Projekt:** Bi-haltige Legierungen dehnen sich beim Erstarren aus → nahezu schwindungskompensiert (→ [[Werkstoffe]]). Konsequenz: Schwindmaß des Modells hängt direkt von der Werkstoffentscheidung ab → **Werkstoff vor finaler Modellfertigung festlegen!**
...
- [ ] Ergebnis fließt in CAD-Modellmaße ein (→ [[Modellbau]])

## Konstruktive Konsequenzen (→ auch [[Giessfehler]])
